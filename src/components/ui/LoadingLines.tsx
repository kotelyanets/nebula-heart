...
const LoadingLines: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-black font-sans text-[1.6em] font-semibold select-none text-white scale-[1.5] md:scale-[2]">
      {/* Animated letters */}
      ...
      {/* Loader background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[100px] z-[1] bg-transparent [mask:repeating-linear-gradient(90deg,transparent_0,transparent_6px,black_7px,black_8px)]">
